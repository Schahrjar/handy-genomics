...
**[2025-06-11] update:**
<br/>
👉 Please use [RNUscanner](https://github.com/Schahrjar/RNUscanner), a more comprehensive tool with easy to use instructions, and scalability to include other RNU genes (RNU2-2, RNU5B-1, RNU5A-1, etc.).
